...
return [
    ...
    */
    ...
    'active_url' => 'Ссылка :attribute не действительна.',
    'after' => 'Значение :attribute должно быть после :date.',
    'after_or_equal' => 'Значение :attribute должно быть после или равно :date.',
    ...
    'before' => 'Значение :attribute должно быть до :date.',
    'before_or_equal' => 'Значение :attribute должно быть до или равно :date.',
    'between' => [
        'numeric' => 'Значение :attribute должно быть между :min и :max.',
        'file' => 'Объем :attribute должен быть между :min и :max килобайт.',
        'string' => 'Длинна :attribute должна быть между :min и :max символов.',
        'array' => 'Длинна :attribute должна быть между :min и :max элементов.',
    ],
