    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade @if($tab == 'default') show active @endif" id="first" role="tabpanel"
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <img class="rounded-circle avatar preview_image"
                         src="http://res.cloudinary.com/happy-moments/image/upload/c_fill,h_150,w_150/1_MccriYX-ciBniUzRKAUsAw_iaukql">
                    <div class="form-group">
                        ...
                        <label class="btn btn-success mb-2" for="files">
                            ...
                            <span class="upload_text">Загрузить аватар</span></label>
                ...
                <div class="row user-data col-md-6">
